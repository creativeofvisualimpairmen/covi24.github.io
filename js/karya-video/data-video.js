var dataVideo = [
'<a onclick="jamilahSimponiHitam()">Jamilah & Adrian Cover Sherina - Simfoni Hitam</a>',
'<a onclick="adrianKutaBali()">Adrian Cover - ANDRE hEHANUSSa - kuta Bali </a>',
'<a onclick="azkaUnintended()">Azka Cover - Muse - Unintended</a>',
'<a onclick="harmoniMerakit()">Harmoni Jiwa Cover Yura Yunita - Merakit</a>',
'<a onclick="harmoniManuk()">Harmoni Jiwa Cover - Manuk Dadali</a>',
